            ...
            <Navbar expand="lg" className="slim-navbar">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ml-auto">
                        <Nav.Link href="/dashboard">Bảng điều khiển</Nav.Link>
                        <Nav.Link href="/property">Tài sản cho thuê</Nav.Link>
                        <Nav.Link href="/complaints">Góp ý</Nav.Link>
                        <NavDropdown
                            title={<div>
                            ...
                            <NavDropdown.Item href="/addProperty">Thêm tài sản cho thuê</NavDropdown.Item>
